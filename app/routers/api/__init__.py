...
from app.models import BuildingMetaPublic, ResourcePublic, Recipe, RecipePublic, Industry
...
async def gamedata(session: SessionDep):
    ...
    return {
        ...
        "buildings": [ BuildingMetaPublic.model_validate(building) for building in buildings],
